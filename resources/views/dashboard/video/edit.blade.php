...
<form action="" method="post">
    ...
    <div class="uk-margin">
    <h1><input type="text" value="{{ $data->titulo }}" class="uk-input uk-form-large" placeholder="Titulo"></h1>
    </div>
    <div class="uk-margin">
        <div uk-form-custom>
            <input type="file">
    ...
    <div class="uk-margin">
        <textarea class="uk-textarea"  placeholder="Descrição" cols="30" rows="10">{{ $data->descricao }}</textarea>
    </div>
